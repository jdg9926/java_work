...
public class KitchenMain {
	public static void main(String[] args) {
		...
		// 부모타입으로 자동 타입변환 할 수 있다.
		// 부모타입으로 만들어진 메서드만 사용할 수 있다.
...
/*
	...
	인터페이스 : 구현 객체의 동일한 실행 기능을 보장하기 위한 목적
	 - 구현한 클래스는 온전히 인터페이스의 기능을 갖추었음을 보장해줌.
	
	인터페이스 사용 예
     - 어플리케이션의 기능을 정의해야 하지만 그 구현방식이나 대상에 대해 추상화 할 때
	 - 서로 관련성이 없는 클래스들을 묶어주고 싶을 때
	 - 다중 상속을 통한 추상화 설계를 해야할 때
	 - 특정 데이터 타입의 행동을 명시할 때, 어디서 그 행동이 구현되는지 특정하지 않았을 때
	 - 클래스와 별도로 구현 객체가 같은 동작을 한다는 것을 보장할 때
